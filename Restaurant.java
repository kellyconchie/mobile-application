...
public class Restaurant extends AppCompatActivity {
    ...
    EditText et_amount;
    CalendarView cal;
    TextView date_textView, expense_list, view_Expenses, pound_textView, restaurant_text, date_selected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurant_text = findViewById(R.id.restaurant_text);
        ...
        add_btn.setOnClickListener(v -> {
            ...
            try {
                expensesModel = new ExpensesModel(-1, date_textView.getText().toString(), Double.parseDouble(et_amount.getText().toString()),
                        restaurant_text.getText().toString());
                Toast.makeText(Restaurant.this, expensesModel.toString(), Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
                expensesModel = new ExpensesModel(-1, "error", 0, "error");
                Toast.makeText(Restaurant.this, "Error creating entry", Toast.LENGTH_SHORT).show();

            }

            DBHelper dataBaseHelper = new DBHelper(Restaurant.this);
        ...
        view_Expenses.setOnClickListener(v -> {
            Intent expenseRestaurant = new Intent(Restaurant.this, Total.class);
            startActivity(expenseRestaurant);
        });
