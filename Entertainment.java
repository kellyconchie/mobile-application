...
public class Entertainment  extends AppCompatActivity {
    ...
    EditText et_amount;
    CalendarView cal;
    TextView date_textView, expense_list, view_Expenses, pound_textView, entertainment_text, date_selected;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_btn.setOnClickListener(v -> {
            ...
            try {
                expensesModel = new ExpensesModel(-1, date_textView.getText().toString(), Double.parseDouble(et_amount.getText().toString()), entertainment_text.getText().toString());
                Toast.makeText(Entertainment.this, expensesModel.toString(), Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
                expensesModel = new ExpensesModel(-1, "error", 0, "error");
                Toast.makeText(Entertainment.this, "Error creating entry", Toast.LENGTH_SHORT).show();

            }

            DBHelper dataBaseHelper = new DBHelper(Entertainment.this);
        ...
        view_Expenses.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent expenseGroceries = new Intent(Entertainment.this, Total.class);
                startActivity(expenseGroceries);
            }
        });
