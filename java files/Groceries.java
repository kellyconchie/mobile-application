...
public class Groceries extends AppCompatActivity {
    ...
    EditText  et_amount;
    CalendarView cal;
    TextView date_textView, expense_list, view_Expenses, pound_textView, groceries_text, date_selected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        groceries_text = findViewById(R.id.groceries_text);
        ...
        add_btn.setOnClickListener(v -> {
            ...
            try {
                expensesModel = new ExpensesModel(-1, date_textView.getText().toString(), Double.parseDouble(et_amount.getText().toString()), groceries_text.getText().toString());
                Toast.makeText(Groceries.this, expensesModel.toString(), Toast.LENGTH_SHORT).show();
            } catch (Exception e) {
                expensesModel = new ExpensesModel(-1, "error", 0, "error");
                Toast.makeText(Groceries.this, "Error creating entry", Toast.LENGTH_SHORT).show();

            }

            DBHelper dataBaseHelper = new DBHelper(Groceries.this);
        ...
        view_Expenses.setOnClickListener(v -> {
            Intent expenseGroceries = new Intent(Groceries.this, Total.class);
